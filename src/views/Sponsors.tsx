                ...
                <Grid item sm={4} xs={12}>
                    <Box sx={{ marginTop: '4%', padding: '2%' }}>
                        ...
                        {!canCheckout && <Form initialValues={formSchema} buttonText="checkout" buttonSize="medium" submit={createUser}>
                            ...
                            {sponsorType === 'Business or Group' && <FormFieldWrapper>
                                <InputField size="small" color="secondary" fullWidth={true} name="entity_name" type="text" variant="outlined" label="Name of business or group" />
                            </FormFieldWrapper>}
                            <FormFieldWrapper>
