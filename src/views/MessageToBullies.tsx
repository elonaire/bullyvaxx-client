...
interface MessageToBulliesProps {
    
}
 
const MessageToBullies: FunctionComponent<MessageToBulliesProps> = () => {
    const [response, setResponse] = React.useState({} as any);
    const [loading, setLoading] = React.useState(false);
    const [selectedPage] = React.useState('Message to Bullies');
...
export default MessageToBullies;